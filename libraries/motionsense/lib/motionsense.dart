...
class Motionsense {
  static const MethodChannel _channel = const MethodChannel('org.md2k.motionsense.channel');
  static const _GET_SETTINGS = 'GET_SETTINGS';
  static const _SAVE_SETTINGS = 'SET_SETTINGS';
  ...
  static Future<void> setSettings(Map _configuration) async {
