...
class CommonFlushBar  {
  Flushbar<bool> showError(BuildContext context, String message){
    return Flushbar<bool>()
      ...
      ..backgroundGradient = new LinearGradient(colors: [Colors.red.shade900, Colors.red.shade300])
  ...
  Flushbar<bool>  showSuccess(BuildContext context, String message){
    return Flushbar<bool>()
      ...
      ..backgroundGradient = new LinearGradient(colors: [Colors.green.shade900, Colors.green.shade300])
      ..duration = Duration(seconds: 3)
