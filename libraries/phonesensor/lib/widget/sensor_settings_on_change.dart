...
class SensorSettingsOnChange extends StatefulWidget {

  _SensorSettingsOnChangeState _sensorSettingsPageState;
  SensorSettingsOnChange(id, sensorInfo,configuration){
    _sensorSettingsPageState = new _SensorSettingsOnChangeState(id, sensorInfo, configuration);
  }

  @override
  _SensorSettingsOnChangeState createState() =>
      _sensorSettingsPageState;
}

class _SensorSettingsOnChangeState extends State<SensorSettingsOnChange> {
  Configuration configuration;
  String id;
  SensorInfo sensorInfo;

  _SensorSettingsOnChangeState(this.id, this.sensorInfo, this.configuration);
