...
class SensorSettingsSecMinHour extends StatefulWidget {

  _SensorSettingsSecMinHourState _sensorSettingsPageState;
  SensorSettingsSecMinHour(id, sensorInfo,configuration){
    _sensorSettingsPageState = new _SensorSettingsSecMinHourState(id, sensorInfo, configuration);
  }

  @override
  _SensorSettingsSecMinHourState createState() =>
      _sensorSettingsPageState;
}

class _SensorSettingsSecMinHourState extends State<SensorSettingsSecMinHour> {
  Configuration configuration;
  String id;
  SensorInfo sensorInfo;

  _SensorSettingsSecMinHourState(this.id, this.sensorInfo, this.configuration);
...
//                Divider(height: 1, color: Colors.grey,),
                ListTile(
                  ...
                  trailing: new DropdownButton<String>(
                    items: <String>['SECONDS', 'MINUTES', 'HOURS']
                        .map((String value) {
                    ...
                    value: this.configuration.getSampleRateUnit(id),
                    onChanged: (String value) {
                      setState(() =>
                          this.configuration.setSampleRateUnit(id, value));
                    },
                  ),
                ),
//                Divider(height: 1, color: Colors.grey,),
